...
class Settings(BaseSettings):
    ...
    # ── 🔴 الحلّ التلقائي بالتشابه (bold resolve) — ملغى بقرار المالك (2026-07-19) ──
    #    التخمين في أسماء الخزائن/الموردين أنزل حوالات على كيانات خاطئة. المسار محفوظ خلف
    #    هذا المفتاح **للتوثيق/التحقيق فقط** ولا يُفعَّل: الاسم غير المحلول صارمًا → تصعيد.
    #    ما يبقى شغّالاً (ليس تخمينًا): الحل الصارم + aliases اليدوية + التطبيع الحتميّ +
    #    طبقة القروب (room_match) + قاعدة الموضع البنيويّ.
    bold_resolve_enabled: bool = Field(default=False)               # ملغى — لا يُفعَّل
