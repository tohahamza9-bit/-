...
SEED_TREASURIES: list[dict] = [
    ...
    # 🔴 «صافي» لا تُطابَق **من نصّ الرسالة** إطلاقًا: `_is_discount_indicator` (parser.py:538)
    #    يعترضها كمؤشّر خصم قبل حلّ الخزائن. بقاؤها هنا لأنّها **وجهة محاسبية** لا مفردة نصّية:
    #    resolve_two_leg_treasury (commission.py:46) يُسندها لصفقات SI ذات المورّد بلا خصم.
    #    حذفها يكسر SI (5 اختبارات) — راجع §5 من تقرير 2026-07-20.
